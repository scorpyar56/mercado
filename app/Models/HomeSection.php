	...
	*/
	public function getValueAttribute($value)
	{
		...
		if (is_array($value) && count($value) > 0) {
			...
			if ($this->method == 'getBanner') {
				if (!isset($value['banner_img_1'])) {
					$value['banner_img_1'] = null;
				}
				if (!isset($value['banner_img_2'])) {
					$value['banner_img_2'] = null;
				}
				if (!isset($value['banner_img_3'])) {
					$value['banner_img_3'] = null;
				}
				if (!isset($value['banner_img_small_1'])) {
					$value['banner_img_small_1'] = null;
				}
				if (!isset($value['banner_img_small_2'])) {
					$value['banner_img_small_2'] = null;
				}
				if (!isset($value['banner_img_small_3'])) {
					$value['banner_img_small_3'] = null;
				}
	...
	public function setValueAttribute($value)
	{
		...
		if (isset($value['banner_img_small_1'])) {
			$bannerImageMobile = [
				...
				'upsize'    => false,
				'quality'   => 100,
				'filename'  => 'bannerMobile1-',
				'orientate' => true,
			];
			$value = $this->upload($value, $bannerImageMobile);
		}

		if (isset($value['banner_img_small_2'])) {
			$bannerImageMobile = [
				'attribute' => 'banner_img_small_2',
				'path'      => 'app/banner',
				'default'   => null,
				'width'     => 354,
				'height'    => 125,
...
{"name":"active","label":"Active","type":"checkbox"}';
		...
		if ($this->method == 'getBanner') {
			...
			{"name":"banner_img_1","label":"Banner Image 1","type":"image","upload":true,"disk":"' . $diskName . '","hint":"getSearchForm_background_image_hint"},
			{"name":"banner_img_2","label":"Banner Image 2","type":"image","upload":true,"disk":"' . $diskName . '","hint":"getSearchForm_background_image_hint"},
			{"name":"banner_img_3","label":"Banner Image 3","type":"image","upload":true,"disk":"' . $diskName . '","hint":"getSearchForm_background_image_hint"},
			{"name":"banner_img_small_1","label":"Mobile Banner Image 1","type":"image","upload":true,"disk":"' . $diskName . '","hint":"getSearchForm_background_image_hint"},
			{"name":"banner_img_small_2","label":"Mobile Banner Image 2","type":"image","upload":true,"disk":"' . $diskName . '","hint":"getSearchForm_background_image_hint"},
			{"name":"banner_img_small_3","label":"Mobile Banner Image 3","type":"image","upload":true,"disk":"' . $diskName . '","hint":"getSearchForm_background_image_hint"}';
		}

		if ($this->method == 'getBanner2') {
			$value = '{"name":"active","label":"Active","type":"checkbox"},
			{"name":"banner_img_1","label":"Banner Image 1","type":"image","upload":true,"disk":"' . $diskName . '","hint":"getSearchForm_background_image_hint"},
			{"name":"banner_img_2","label":"Banner Image 2","type":"image","upload":true,"disk":"' . $diskName . '","hint":"getSearchForm_background_image_hint"},
			{"name":"banner_img_3","label":"Banner Image 3","type":"image","upload":true,"disk":"' . $diskName . '","hint":"getSearchForm_background_image_hint"},
