...
class HomeSectionController extends PanelController
{
	...
	public function reset($action)
	{
		...
		if ($action == 'reset_reorder') {
			...
			HomeSection::where('method', 'getLatestJobs')->update(['lft' => 16, 'rgt' => 17, 'active' => 1]);
			HomeSection::where('method', 'getBanner')->update(['lft' => 16, 'rgt' => 17, 'active' => 1]);
		...
		if ($action == 'reset_settings') {
			...
			HomeSection::where('method', 'getLatestJobs')->update(['value' => null, 'active' => 1]);
			HomeSection::where('method', 'getBanner')->update(['value' => null, 'active' => 1]);
