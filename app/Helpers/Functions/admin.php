...
//E.K.
function ajaxReviewedDisplay($id, $table, $field, $fieldValue = null)
{
    $lineId = $field.$id;
    $lineId = str_replace('.', '', $lineId); // fix JS bug (in admin layout)
    $data = 'data-table="' . $table . '" 
    ...
    $html = '<div class="dropdown">
                  <button id="' . $lineId . '" class="dropbtn ' . $class . '" ' . $data .  ' > ' . $lable . ' </button>
                  <div class="dropdown-content">
                        <a href="" class="reviewed-request" data-value="0">Rejected</a>
                        <a href="" class="reviewed-request" data-value="1">In process</a>
                        <a href="" class="reviewed-request" data-value="2">Confirmed</a>
                  </div>
            </div>';
