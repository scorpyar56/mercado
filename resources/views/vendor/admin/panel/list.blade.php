...
@section('after_scripts')
    ...
    <script type="text/javascript">
        jQuery(document).ready(function($) {
            ...
            console.log("{{ url($xPanel->route.'/search').'?'.Request::getQueryString() }}");
			...
			//E.K.
            $('#crudTable').on('click', function() {
                $('select.ad_status').on('change', function() {
                    let e = $('option:selected', this).val();
                    console.log(e);
                })
            })
